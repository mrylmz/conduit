...
void main() {
  ...
  group('Client behavior', () {
    ...
    test('Can add a new public client', () async {
      ...
      var clientResult = result!.asClient();
      expect(clientResult.id, 'pub-id');
      expect(clientResult.hashedSecret, isNull);
      expect(clientResult.salt, isNull);
      expect(clientResult.redirectURI, isNull);
      expect(clientResult.supportsScopes, false);
      expect(clientResult.allowedScopes, isNull);
    });
